...
This web page code requires the use of a stats database which is created by XpKiller's Procon "BF3 Chat, GUID, Stats and Mapstats Logger" Plugin.
...
https://github.com/tyger07/BF3-Server-Stats/commits/master
